...
    await connection.execute(`create table Clinician ( id number generated always as identity, 
    ...
    await connection.execute(`create table Patients ( id number generated always as identity, 
        last_name varchar2(100),
        first_name varchar2(100),
    ...
    await connection.execute(`create table Equipment ( id number generated always as identity, 
